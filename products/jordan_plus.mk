# Inherit AOSP device configuration for jordan_plus.
$(call inherit-product,  device/moto/mb526/full_jordan_plus.mk)
...
PRODUCT_PACKAGE_OVERLAYS += vendor/aokp/overlay/jordan_plus

# Setup device specific product configuration.
PRODUCT_NAME := aokp_jordan_plus
PRODUCT_BRAND := MOTO
